...
double result = Math.Round(
    DistanceTwoPoints(x1Coordinate, y1Coordinate, z1Coordinate, x2Coordinate, y2Coordinate, z2Coordinate),
    2, MidpointRounding.ToZero
);
Console.WriteLine(result);

double DistanceTwoPoints(int x1, int y1, int z1, int x2, int y2, int z2)
{
    int cat1 = x1 - x2;
    int cat2 = y1 - y2;
    int cat3 = z1 - z2;
